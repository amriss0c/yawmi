...
class DatabaseHelper {
  ...
  Future<Database> get database async {
    ...
    _database = await _initDB('wirdi.db');
    return _database!;
  }
  ...
  Future<bool> mergeRemoteTask(DayTask remote) async {
    final existing = await getTask(remote.date);
    if (existing == null || remote.isNewerThan(existing)) {
